...
public final class ObjectDef {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		FileOperations.WriteFile("" + signlink.findcachedir() + "/LOC/loc.dat",
				streamLoader.getDataForName("loc.dat"));
		FileOperations.WriteFile("" + signlink.findcachedir() + "/LOC/loc.idx",
		...
		// System.out.println("WROTE THE LOC FILES INTO CACHE - Dir; "+signlink.findcachedir()+"");
		for (int k = 0; k < 20; k++) {
			cache[k] = new ObjectDef();
			/*
			 * for (int I = 0; I < totalObjects; I++) { ObjectDef D =
			 * ObjectDef.forID(I); if (D.anIntArray773 != null) { for (int i2 =
			 * 0; i2 < D.anIntArray773.length; i2++) { byte[] Byte0 =
			 * FileOperations.ReadFile("525Models/" + D.anIntArray773[i2] +
			 * ".dat"); FileOperations.WriteFile("508 Models/" +
			 * D.anIntArray773[i2] + ".dat", Byte0); } } }
			 */
		}
	}
