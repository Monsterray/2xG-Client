...
public final class TextDrawingArea extends DrawingArea {
	...
	public TextDrawingArea(boolean flag, String s, StreamLoader streamLoader) {
		try {
			int length = !s.equals("hit_full") && !s.equals("critical_full") ? 256
					: 58;
			...
			Stream stream = new Stream(
					streamLoader.getDataForName((new StringBuilder()).append(s)
							.append(".dat").toString()));
			...
			if (c != ' ') {
				method394(192, i + anIntArray1494[c] + 1,
						aByteArrayArray1491[c], anIntArray1492[c], i1
								+ anIntArray1495[c] + 1, anIntArray1493[c], 0);
				method394(j1, i + anIntArray1494[c], aByteArrayArray1491[c],
						anIntArray1492[c], i1 + anIntArray1495[c],
						anIntArray1493[c], j);
			}
			i += anIntArray1496[c];
