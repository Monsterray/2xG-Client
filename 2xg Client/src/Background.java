public final class Background extends DrawingArea {
	...
	public Background(StreamLoader streamLoader, String fileName, int i) {
		Stream stream = new Stream(streamLoader.getDataForName((new StringBuilder()).append(fileName).append(".dat").toString()));
		...
		if(fileName.equals("mapscene") || fileName.equals("mapfunction")){
			System.out.println("-----------------------------");
	
			System.out.println("String fileName:" + fileName);
			System.out.println("int i:" + i);
			
			System.out.println("int 1452:" + anInt1452);
			System.out.println("int 1453:" + anInt1453);
			System.out.println("int 1454:" + anInt1454);
			System.out.println("int 1455:" + anInt1455);
			System.out.println("int 1456:" + anInt1456);
			System.out.println("int 1457:" + anInt1457);
